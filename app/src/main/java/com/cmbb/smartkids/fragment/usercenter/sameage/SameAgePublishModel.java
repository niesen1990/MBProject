...
public class SameAgePublishModel implements Parcelable {
    ...
    public SameAgePublishModel() {
    }

    protected SameAgePublishModel(Parcel in) {
    ...
    public static final Creator<SameAgePublishModel> CREATOR = new Creator<SameAgePublishModel>() {
        public SameAgePublishModel createFromParcel(Parcel source) {
            return new SameAgePublishModel(source);
        }

        public SameAgePublishModel[] newArray(int size) {
            return new SameAgePublishModel[size];
        }
    };
}