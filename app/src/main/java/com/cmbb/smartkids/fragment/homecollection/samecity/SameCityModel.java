...
public class SameCityModel implements Parcelable {
    ...
    public SameCityModel() {
    }

    protected SameCityModel(Parcel in) {
    ...
    public static final Parcelable.Creator<SameCityModel> CREATOR = new Parcelable.Creator<SameCityModel>() {
        public SameCityModel createFromParcel(Parcel source) {
            return new SameCityModel(source);
        }

        public SameCityModel[] newArray(int size) {
            return new SameCityModel[size];
        }
    };
}