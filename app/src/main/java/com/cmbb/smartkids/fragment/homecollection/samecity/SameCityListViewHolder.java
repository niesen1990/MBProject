 ...
 * 创建时间：2015/7/1 11:00
 */
public class SameCityListViewHolder extends RecyclerView.ViewHolder {
    ...
    private SameCityListViewHolder(View view) {
        super(view);
    ...
    public static SameCityListViewHolder create(final Context context, ViewGroup parent) {
        ...
        return new SameCityListViewHolder(v);
    }

    public void onBindViewHolder(Context context, final SameCityModel entry) {
