 ...
 * Created by N.Sun
 */
public class ExpertDetailModel implements Parcelable {
    ...
    public ExpertDetailModel() {
    }

    protected ExpertDetailModel(Parcel in) {
    ...
    public static final Parcelable.Creator<ExpertDetailModel> CREATOR = new Parcelable.Creator<ExpertDetailModel>() {
        public ExpertDetailModel createFromParcel(Parcel source) {
            return new ExpertDetailModel(source);
        }

        public ExpertDetailModel[] newArray(int size) {
            return new ExpertDetailModel[size];
        }
    };
}
