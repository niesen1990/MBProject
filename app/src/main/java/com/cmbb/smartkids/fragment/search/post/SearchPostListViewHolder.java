 ...
 * 创建时间：2015/7/1 11:00
 */
public class SearchPostListViewHolder extends RecyclerView.ViewHolder {
    ...
    private SearchPostListViewHolder(View view) {
        super(view);
    ...
    public static SearchPostListViewHolder create(final Context context, ViewGroup parent) {
        View v = LayoutInflater.from(context).inflate(R.layout.activity_home_collection_list_item, parent, false);
        v.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SearchModel mSearchModel = (SearchModel) v.getTag();
                PostModel mPostModel = new PostModel();
                mPostModel.setNike(mSearchModel.getNike());
                mPostModel.setTitle(mSearchModel.getTitle());
                mPostModel.setType(mSearchModel.getType());
                mPostModel.setAuthority(mSearchModel.getAuthority());
                mPostModel.setId(mSearchModel.getId());
                mPostModel.setAreaId(mSearchModel.getAreaId());
                mPostModel.setAreaName(mSearchModel.getAreaName());
                mPostModel.setAttent(mSearchModel.getAttent());
                mPostModel.setAreaType(mSearchModel.getAreaType());
                mPostModel.setBigImg(mSearchModel.getBigImg());
                mPostModel.setContext(mSearchModel.getContext());
                mPostModel.setCream(mSearchModel.getCream());
                mPostModel.setUserSmallHeadImg(mSearchModel.getUserSmallHeadImg());
                mPostModel.setDate(mSearchModel.getDate());
                mPostModel.setLoginTimes(mSearchModel.getLoginTimes());
                mPostModel.setPlateName(mSearchModel.getPlateName());
                mPostModel.setEredar(mSearchModel.getEredar());
                mPostModel.setEredarName(mSearchModel.getEredarName());
                mPostModel.setEredarRank(mSearchModel.getEredarRank());
                mPostModel.setEredarType(mSearchModel.getEredarType());
                mPostModel.setWeixinImg(mSearchModel.getWeixinImg());
                mPostModel.setValidCurrentUser(mSearchModel.getValidCurrentUser());
                mPostModel.setPortConnector(mSearchModel.getPortConnector());
                mPostModel.setUserId(mSearchModel.getUserId());
                mPostModel.setStore(mSearchModel.getStore());
                mPostModel.setRelpys(mSearchModel.getRelpys());
                Intent intent = null;
        ...
        return new SearchPostListViewHolder(v);
    }
