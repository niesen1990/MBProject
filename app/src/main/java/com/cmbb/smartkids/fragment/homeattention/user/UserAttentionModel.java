 ...
 * Created by N.Sun
 */
public class UserAttentionModel implements Parcelable {
    private String attentionToken;
    ...
    public void setAttentionToken(String attentionToken) {
        this.attentionToken = attentionToken;
    }
    ...
    /**
     * @param attentionCount The attentionCount
     */
     ...
     * @param eredarName The eredarName
     */
    public void setFlag(String eredarName) {
        this.flag = eredarName;
    }
    ...
    /**
     * @param publishCount The publishCount
     */
    ...
    /**
     * @return The userWeiXinHeadImg
     */
    public String getUserWeiXinHeadImg() {
        return userWeiXinHeadImg;
    }

    /**
     * @param userWeiXinHeadImg The userWeiXinHeadImg
     */
    public void setUserWeiXinHeadImg(String userWeiXinHeadImg) {
        this.userWeiXinHeadImg = userWeiXinHeadImg;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeString(this.attentionToken);
        dest.writeValue(this.attentionCount);
    ...
    protected UserAttentionModel(Parcel in) {
        this.attentionToken = in.readString();
        this.attentionCount = (Integer) in.readValue(Integer.class.getClassLoader());
        ...
        this.publishCount = (Integer) in.readValue(Integer.class.getClassLoader());
        ...
        this.storeCount = (Integer) in.readValue(Integer.class.getClassLoader());
    ...
    public static final Creator<UserAttentionModel> CREATOR = new Creator<UserAttentionModel>() {
        public UserAttentionModel createFromParcel(Parcel source) {
            return new UserAttentionModel(source);
        }

        public UserAttentionModel[] newArray(int size) {
