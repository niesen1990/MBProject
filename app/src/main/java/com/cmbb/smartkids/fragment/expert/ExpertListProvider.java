...
import com.cmbb.smartkids.fragment.master.EredarTypeBaseModel;
 ...
 * 创建时间：2015/7/1 10:56
 */
public class ExpertListProvider extends DataController<MasterTypeModel> {

    private Context mContext;

    public ExpertListProvider(Context context) {
        mContext = context;
    }
