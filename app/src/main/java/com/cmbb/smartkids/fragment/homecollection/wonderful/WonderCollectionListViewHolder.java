 ...
 * 创建时间：2015/7/1 11:00
 */
public class WonderCollectionListViewHolder extends RecyclerView.ViewHolder {
    ...
    private WonderCollectionListViewHolder(View view) {
        super(view);
    ...
    public static WonderCollectionListViewHolder create(final Context context, ViewGroup parent) {
        ...
        return new WonderCollectionListViewHolder(v);
    }

    public void onBindViewHolder(Context context, final WonderCollectionModel entry) {
