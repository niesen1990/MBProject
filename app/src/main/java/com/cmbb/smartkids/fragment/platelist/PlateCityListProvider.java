...
import com.cmbb.smartkids.fragment.homeplate.HomePageBaseModel;
 ...
 * 创建时间：2015/7/1 10:56
 */
public class PlateCityListProvider extends DataController<PlateModel> {

    private Context mContext;

    public PlateCityListProvider(Context context) {
        mContext = context;
    }
