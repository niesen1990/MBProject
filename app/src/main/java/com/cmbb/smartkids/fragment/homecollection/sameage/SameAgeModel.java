...
public class SameAgeModel implements Parcelable {
    ...
    protected SameAgeModel(Parcel in) {
    ...
    public static final Parcelable.Creator<SameAgeModel> CREATOR = new Parcelable.Creator<SameAgeModel>() {
        public SameAgeModel createFromParcel(Parcel source) {
            return new SameAgeModel(source);
        }

        public SameAgeModel[] newArray(int size) {
            return new SameAgeModel[size];
        }
    };
}