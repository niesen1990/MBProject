...
public class WonderPublicModel implements Parcelable {
    ...
    public WonderPublicModel() {
    }

    protected WonderPublicModel(Parcel in) {
    ...
    public static final Creator<WonderPublicModel> CREATOR = new Creator<WonderPublicModel>() {
        public WonderPublicModel createFromParcel(Parcel source) {
            return new WonderPublicModel(source);
        }

        public WonderPublicModel[] newArray(int size) {
            return new WonderPublicModel[size];
        }
    };
}