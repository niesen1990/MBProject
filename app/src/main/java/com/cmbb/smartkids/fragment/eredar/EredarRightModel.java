 ...
 * Created by N.Sun
 */
public class EredarRightModel implements Parcelable {
    ...
    public EredarRightModel() {
    }

    protected EredarRightModel(Parcel in) {
    ...
    public static final Creator<EredarRightModel> CREATOR = new Creator<EredarRightModel>() {
        public EredarRightModel createFromParcel(Parcel source) {
            return new EredarRightModel(source);
        }

        public EredarRightModel[] newArray(int size) {
            return new EredarRightModel[size];
        }
    };
}
