 ...
 * 修改备注：
 */
public class FragmentGuideOne extends MFragment {
    private static final String TAG = FragmentGuideOne.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        iv_guide_bac.setImageResource(R.drawable.guide_bac_01);
        return rootView;
    }
}
