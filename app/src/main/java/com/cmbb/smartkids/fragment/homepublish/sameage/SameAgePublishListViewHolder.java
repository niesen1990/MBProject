 ...
 * 创建时间：2015/7/1 11:00
 */
public class SameAgePublishListViewHolder extends RecyclerView.ViewHolder {
    ...
    private SameAgePublishListViewHolder(View view) {
        super(view);
    ...
    public static SameAgePublishListViewHolder create(final Context context, ViewGroup parent) {
