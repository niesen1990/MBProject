 ...
 * 创建时间：2015/7/1 11:00
 */
public class SameAgeListViewHolder extends RecyclerView.ViewHolder {
    ...
    private SameAgeListViewHolder(View view) {
        super(view);
    ...
    public static SameAgeListViewHolder create(final Context context, ViewGroup parent) {
        ...
        return new SameAgeListViewHolder(v);
    }

    public void onBindViewHolder(Context context, final SameAgeModel entry) {
