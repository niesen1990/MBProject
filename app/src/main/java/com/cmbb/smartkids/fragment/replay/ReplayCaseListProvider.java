 ...
 * 创建时间：2015/7/1 10:56
 */
public class ReplayCaseListProvider extends DataController<ReplayModel> {
    CaseDetailListModel mCaseDetailListModel;
    private int sort = 2;
    private int id = -1;

    public ReplayCaseListProvider(CaseDetailListModel caseDetailListModel) {
    ...
    public void doInitialize(Callback callback) {
        ...
        OkHttp.asyncPost(Constants.Case.FINDREPLYS_URL, body, callback);
    }
