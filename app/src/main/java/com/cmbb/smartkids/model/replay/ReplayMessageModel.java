...
public class ReplayMessageModel implements Parcelable {
    ...
    public ReplayMessageModel() {
    }

    protected ReplayMessageModel(Parcel in) {
    ...
    public static final Creator<ReplayMessageModel> CREATOR = new Creator<ReplayMessageModel>() {
        public ReplayMessageModel createFromParcel(Parcel source) {
            return new ReplayMessageModel(source);
        }

        public ReplayMessageModel[] newArray(int size) {
            return new ReplayMessageModel[size];
        }
    };
}