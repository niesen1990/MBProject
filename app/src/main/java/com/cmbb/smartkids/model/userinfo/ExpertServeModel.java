 ...
 */
public class ExpertServeModel implements Parcelable {
    ...
    public ExpertServeModel() {
    }

    protected ExpertServeModel(Parcel in) {
    ...
    public static final Parcelable.Creator<ExpertServeModel> CREATOR = new Parcelable.Creator<ExpertServeModel>() {
        public ExpertServeModel createFromParcel(Parcel source) {
            return new ExpertServeModel(source);
        }

        public ExpertServeModel[] newArray(int size) {
            return new ExpertServeModel[size];
        }
    };
}
